...
class OnlineCertifications extends StatefulWidget {
  final String userDep;
  final String userYear;
  final String userUid;

  OnlineCertifications({this.userDep, this.userUid, this.userYear});

  @override
  _OnlineCertificationsState createState() => _OnlineCertificationsState();
}

class _OnlineCertificationsState extends State<OnlineCertifications> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Online Certifications'),
      ),
      body: SingleChildScrollView(
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .doc(widget.userUid)
              .collection('onlinecertification')
              .snapshots(),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              //     .collection('onlinecertification')
              //     .doc('oc').set(snapshot.data.docs.first.data());
              return Column(
                      ...
                      child: Column(
                        ...
                        children: [
                          Provider.of<Helpers>(context, listen: false)
                              .headingWidget(
                            context,
                            'Online Certifications'.toUpperCase(),
                          ),
                          SizedBox(
                            height: 10.0,
                          ),
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Container(
                              ...
                              height: 50.0,
                              width: MediaQuery.of(context).size.width,
                              child: Provider.of<Helpers>(context)
                                  .headingWidget(
                                      context, 'Certificates Earned'),
                            ),
                          ),
                          SizedBox(
