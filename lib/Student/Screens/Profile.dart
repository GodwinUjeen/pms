...
class ProfileDetails extends StatefulWidget {
  ...
  ProfileDetails({this.userDep, this.userUid, this.userYear, this.title});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.title,
          style: TextStyle(fontSize: 20.0, color: Colors.brown.shade700),
        ),
      ),
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshots) {
          if (snapshots.connectionState == ConnectionState.waiting) {
            ...
            //     .collection('profile')
            //     .doc('studentprofile').set(snapshots.data.data());
...
//Contact Info
                      ...
                      Provider.of<Helpers>(context, listen: false).textWidget(
                          context, 'State', snapshots.data.data()['tempstate']),
                      Provider.of<Helpers>(context, listen: false).textWidget(
                          context,
                          'Country',
                              ...
                              children: [
                                ...
                                snapshots.data.data()['modeoftransport'] ==
                                    ...
                                    ? Provider.of<Helpers>(context,
                                            listen: false)
                                        .textWidget(context, 'College Bus No',
                                            snapshots.data.data()['busno'].toString())
                                    : snapshots.data
                                                .data()['modeoftransport'] ==
                                            'own vehicle'
                                        ? Column(
                                  ...
                                  children: [
                                    ...
                                    Provider.of<Helpers>(context, listen: false)
                                        .textWidget(
                                            ...
                                            snapshots.data.data()['laddline1']),
                                    Provider.of<Helpers>(context, listen: false)
                                        .textWidget(context, 'Address Line 2',
                                            snapshots.data.data()['laddline2']),
                                    Provider.of<Helpers>(context, listen: false)
...
// https://trailhead.salesforce.com/en/users/manot/trailmixes/inno-valley-works-admin-basics
